          ...
          <section class="wrapper">
              <div class="row">
                  <div class="col-lg-12 main-chart">
						...
						<?php }?>
							<div class="col-sm-3">
								<div class="panel panel-primary">
									...
									<h4><i class="fa fa-user"></i> Silahkan Pilih Gambar </h4>
									</div>
									<div class="panel-body">
										<center><img src="assets/img/user/<?php echo $hasil['gambar'];?>"  alt="#" style="width:300px; height: 350px; border:4px solid #ddd;"/></center>			
									</div>
					...
					<div class="clearfix" style="padding-top:250px;"></div>
				  </div>
              </div>
          </section>
      </section>
